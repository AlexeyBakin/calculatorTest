...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("""
                ...
                Данный калькулятор способен выполнять вычисления исключительно с числами от 1 до 10 включительно.
                Для вычисления можно использовать как арабские, так и римские числа.
                Вводить одновременно можно только числа одного типа.
                Введите запрос:""");
