...
public class Symbol {
    ...
    public int indexOfSymbol (@NotNull String string) {
        if (string.contains("+")) {
    ...
    public String whatASymbol (@NotNull String string) {
        if (string.contains("+")) {
            return "+";
        } else {
            if (string.contains("-")) {
